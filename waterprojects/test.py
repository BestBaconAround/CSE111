...
from waterproject import pressure_gain_from_water_height
...
from waterproject import pressure_loss_from_pipe
...
def test_pressure_loss_from_pipe():
    ...
    assert pressure_loss_from_pipe(0.048692, 200, 0.018, 0.0) == approx(0.0, abs=0.001)
...
from waterproject import pressure_loss_from_fittings
...
from waterproject import reynolds_number
...
from waterproject import pressure_loss_from_pipe_reduction

def test_pressure_loss_from_pipe_reduction():
    assert pressure_loss_from_pipe_reduction(0.28687, 0.0, 1, 0.048692) == approx(0, abs=0.001)
